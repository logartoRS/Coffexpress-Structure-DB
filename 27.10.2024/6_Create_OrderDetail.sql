...
CREATE TABLE OrderDetail (
    ...
    CONSTRAINT FK_OrderDetail_Order_id_order FOREIGN KEY (id_order) REFERENCES Order (id_order) ON DELETE NO ACTION,
    CONSTRAINT FK_OrderDetail_Product_id_product FOREIGN KEY (id_product) REFERENCES Product (id_product) ON DELETE NO ACTION
);
